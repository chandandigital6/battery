...
window.toggleMenu = toggleMenu;
  ...
  <div class="fixed bottom-4 right-4 z-30">
    ...
    <button 
      id="menuToggleBtn"
      class="bg-green-500 text-white p-4 rounded-full shadow-lg hover:bg-green-600 focus:outline-none">
    ...
    <div 
      id="menuOptions"
      class="hidden flex-col items-center gap-4 mt-4">
      <!-- WhatsApp Option -->
      <a 
        href="https://wa.me/8090354027" 
        target="_blank" 
        class="bg-green-500 hover:bg-green-600 text-white p-3 rounded-full shadow-lg flex items-center justify-center w-12 h-12">
      ...
      <a 
        href="tel:8090354027" 
        class="bg-green-500 hover:bg-green-600 text-white mt-1 p-3 rounded-full shadow-lg flex items-center justify-center w-12 h-12">
        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
