...
<!-- Bottom Toggle Button -->
  ...
  <div class="fixed bottom-6 right-6">
    <button id="whatsapp-toggle" class="bg-green-500 p-4 rounded-full text-white shadow-lg hover:bg-green-600 transition">
   <a href="https://wa.me/8090354027"><i class="ri-whatsapp-line text-2xl md:text-3xl"></i></a>
    </button>
  </div>

  <!-- WhatsApp Chat Box -->
  {{-- <div id="whatsapp-chat" class="hidden fixed bottom-20 right-6 bg-white rounded-lg shadow-lg p-4 w-64 z-10">
    <h3 class="text-lg font-semibold text-gray-800">Chat with Us</h3>
    <p class="text-sm text-gray-600">We are here to help you! Start a conversation.</p>
    <a href="https://wa.me/your-phone-number" target="_blank" class="mt-3 inline-block text-green-500 hover:text-green-700">
      Start Chat
    </a>
  </div> --}}

  <script>
    // Toggle WhatsApp chat box visibility
